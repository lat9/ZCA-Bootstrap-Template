...
foreach ($categories as $next_category) {
    ...
    $grid_category_card_params = $grid_category_card_params ?? 'categoryListBoxContents card mb-3 p-3 text-center';
    $grid_category_wrap_classes = $grid_category_wrap_classes ?? 'col';
