# ZCA Bootstrap Template v3.7.8 for zc158, zc200 and zc210
...
- Supports Zen Cart major versions **1.5.8** through **2.1.0**, best when run on a zc210 installation.  Validated on PHP versions 7.4 through 8.4.
