# ZCA Bootstrap Template v3.7.9 for zc158, zc20x, zc210 and zc22x
...
- Supports Zen Cart major versions **1.5.8** through **2.2.1**, best when run on a zc221 installation.  Validated on PHP versions 7.4 through 8.5.
...
- ***All*** pages listing products (`advanced_search_results/search_results`, `featured_products`,  `products_all`, `products_new` , `specials` and `index&cPath`) 
